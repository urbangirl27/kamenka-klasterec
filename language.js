...
const translations = {
  en: {
    ...
    homeTitle: 'Rest in comfort beneath rustic wooden beams',
    homeLead: 'Kamenka offers spacious, comfortable accommodation in a characterful historic building in Klášterec nad Ohří. With exposed brick, heavy wooden beams and plenty of room to settle in, it is well suited to corporate travellers and longer work stays, as well as families, friends and visitors exploring the surrounding area.',
    enquire: 'Enquire now',
    homeCharacterTitle: 'Open space with character',
    homeCharacterText: 'A former warehouse from the age of Bohemia’s great porcelain makers, Kamenka has been thoughtfully converted into warm, rustic accommodation. White walls, exposed brick and substantial wooden beams give the space its distinctive character, while the open-plan living and dining area leads out onto a balcony overlooking the surroundings.',
